...
import { saveDepotAdminDetails } from "../utils/dbHelper";
...
export default function CollectExpertDetails(props) {
  ...
  function handleSubmit(e) {
    ...
    let tal = document.getElementById("expertPosition").value;
    let contact = document.getElementById("expertContact").value;

    if (name.length === 0 || tal.length === 0) {
      alert("Invalid data");
    } else {
      saveDepotAdminDetails(name, props.email, tal, contact, props.btnFunc);
          ...
          <div className="relative bg-white rounded-lg shadow dark:bg-white-200">
            ...
            <div className="py-6 px-6 lg:px-8">
              ...
              <form className="space-y-6" action="#">
                ...
                <button
                  type="submit"
                  className="w-full text-black font-medium rounded-lg text-sm px-5 py-2.5 text-center btn btn-compatible border-2 border-compatible"
